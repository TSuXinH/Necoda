...
@torch.no_grad()
def evaluate(model, evaluate_data_loader, local_rank, args, epoch=1, huffman_coding=False, generalization_id=1):
    ...
    if quant_ckt is not None:
        ...
        args.tif_max, args.tif_min = evaluate_data_loader.dataset.tif_max, evaluate_data_loader.dataset.tif_min
        ...
        quant_all = {'quant_embed': quant_emb_s, 'm_args': args}
        raw_all = {'raw_ckt': raw_ckt, 'raw_embed': vid_emb_s, 'm_args': args}
        ...
        if args.quant_embed_bit == 4:
            ...
            args_dict['emb_dim'] = args.emb_dim
            args_dict['s_rate_list'] = args.s_rate_list
            args_dict['t_rate_list'] = args.t_rate_list
