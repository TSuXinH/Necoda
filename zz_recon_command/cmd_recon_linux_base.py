...
for cur_epoch in [60]:
    ...
    base_path = '/mnt/nas/YZ_personal_storage/xxh/proj/proj_dc/exp/nerp_base/noise/s_gen/nerp_base_B2_E100_chns32,32,32_Q_M8_E4_lr0.0002_L2_min_max_s4t4'
    ...
    os.system('python recon_nerp_base.py -d {} -e {} --name recon_{} -g {}'.format(base_path, cur_epoch, cur_epoch, gen_id_list))
