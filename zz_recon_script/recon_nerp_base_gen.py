...
def main():
    ...
    model = NeRPBase(
        ...
        embedding_dim=m_args.emb_dim,
        s_rate_list=m_args.s_rate_list,
        t_rate_list=m_args.t_rate_list,
    ...
    for item in args.generalization_id_list:
        ...
        print('Decoding PPS: {}'.format(len(vid_embed) / decoding_time))
