...
from model_box import NeRPBase, NeRPBaseDecoder
...
def main():
    ...
    model = NeRPBase(
        ...
        embedding_dim=args_dict['emb_dim'],
        s_rate_list=args_dict['s_rate_list'],
        t_rate_list=args_dict['t_rate_list'],
        chns_list=args_dict['chns_list'],
    )
    img_decoder = NeRPBaseDecoder(model).to(device)
