...
from model_box import NeRPSTModeInterp, NeRPSTModeInterpDecoder
...
def main():
    ...
    model = NeRPSTModeInterp(
        ...
        interp_method=m_args.interp_method
    )
    img_decoder = NeRPSTModeInterpDecoder(model).to(device)
