...
data_path = '/slfm/xxh/others/proj_dc/data/s_gen/2/Fsim.tiff'
result_root = '/slfm/xxh/others/proj_dc/exp/nerp_st_huff/s_gen/noise'
gen_data_path1 = '/slfm/xxh/others/proj_dc/data/s_gen/1/Fsim.tiff'
        ...
        for b in [2]:
            for ef in [10]:
                for lr in [2e-4]:
                    ...
                    --lam_temporal {}  --lam_spatial {} --quant_embed_bit 4 --interp_size_x 8 --interp_size_t 8 --remark training2interp8 \
