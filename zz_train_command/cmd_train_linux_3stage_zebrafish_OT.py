...
cuda_id = 3
data_path = '/mnt/nas00/YZ_personal_storage/DeepCompress/Database/148_hi_low_noise/Zebrafish/OT/movie/ZebrafishOT_lowSNR_raw_resized.tif'
result_root = '/mnt/nas00/YZ_personal_storage/xxh/proj/proj_dc/exp/nerp_st_3stage/zebrafish/OT'
gen_data_path_all = ''
        ...
        for b in [2]:
            for ef in [10]:
                for lr in [2e-4]:
                    ...
                    --lam_temporal {}  --lam_spatial {} --quant_embed_bit 4 --interp_size_x 4 \
                    --interp_size_t 4 --epoch_stage1 30 --epoch_stage2 50 --remark s1_30_s2_50 \
