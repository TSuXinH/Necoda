...
result_root = '/slfm/xxh/others/proj_dc/exp/nerp_st_huff/s_gen/noise'
gen_data_path1 = '/mnt/nas/YZ_personal_storage/DeepCompress/simulation_generalization/2/Fsim.tiff'
gen_data_path2 = '/mnt/nas/YZ_personal_storage/DeepCompress/simulation/Fsim.tiff'
        ...
        for b in [2]:
            for ef in [10]:
                for lr in [2e-4]:
                    ...
                    --lam_temporal {}  --lam_spatial {} --quant_embed_bit 4 --remark interp8 --interp_size_x 8 --jiang \
                    --interp_size_t 8 --epoch_stage1 20 --epoch_stage2 100 --remark s1_20_s2_100_r0 \
