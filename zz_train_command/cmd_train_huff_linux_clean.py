...
data_path = '/slfm/xxh/others/proj_dc/data/s_gen/2/Fsim_clean.tiff'
result_root = '/slfm/xxh/others/proj_dc/exp/nerp_st_huff/s_gen/clean'
gen_data_path1 = '/slfm/xxh/others/proj_dc/data/s_gen/1/Fsim_clean.tiff'
        ...
        for b in [2]:
            for ef in [10]:
                for lr in [2e-4]:
                    ...
                    --lam_temporal {}  --lam_spatial {} --quant_embed_bit 4 --interp_size_x 4 --interp_size_t 4 \
                    --remark training2 \
