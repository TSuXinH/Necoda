...
result_root = '/slfm/xxh/others/proj_dc/exp/nerp_st_mode_interp/s_gen/clean'
    ...
    for b in [2]:
        for ef in [100]:
            for lr in [2e-4]:
                ...
                --chns_list {} -g {} --lam_perceptual {}  --selected_perceptual_layer {} --interp_chn 16 \
                --lam_temporal {}  --lam_spatial {}  --interp_method conv --remark stemb1_interpxt4 \
