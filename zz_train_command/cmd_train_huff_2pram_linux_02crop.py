...
data_path = '/slfm/xxh/others/proj_dc/data/2pram/02/02_cropped.tif'
result_root = '/slfm/xxh/others/proj_dc/exp/nerp_st_huff/2pram/02_raw'
gen_data_path_all = '/slfm/xxh/others/proj_dc/data/2pram/02/02_raw.tif'
        ...
        for b in [2]:
            for ef in [10]:
                for lr in [2e-4]:
                    ...
                    --lam_temporal {}  --lam_spatial {} --quant_embed_bit 4 --remark interp6 \
                    --interp_size_x 6 --interp_size_t 6 \
