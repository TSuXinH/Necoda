...
data_path = '/mnt/nas00/YZ_personal_storage/DeepCompress/Database/Ephys/GCaMP6f_11cells_Chen2013/{}/cell3_002_001.tif'.format(cell_name)
result_root = '/mnt/nas00/YZ_personal_storage/xxh/proj/proj_dc/exp/nerp_st_3stage/ephys/GCaMP6f_11cells_Chen2013/{}'.format(cell_name)
gen_data_path_all = ''
for item in range(2, 7):
    gen_data_path_all += '/mnt/nas00/YZ_personal_storage/DeepCompress/Database/Ephys/GCaMP6f_11cells_Chen2013/{}/cell3_002_{}.tif '.format(cell_name, str(item).zfill(3))
