...
result_root = '/mnt/nas00/YZ_personal_storage/xxh/proj/proj_dc/exp/nerp_st_3stage/gen/group8_12_group6_2 '
...
for loss in ['L2']:
    for e in [100]:
        for b in [2]:
            for ef in [10]:
                for lr in [2e-4]:
                    os.system("CUDA_VISIBLE_DEVICES=2 python train_3stage.py --pre_norm {} --output_path {} --data_path {} \
