...
cuda_id = 0
data_path = '/mnt/nas00/YZ_personal_storage/DeepCompress/Database/148_hi_low_noise/Drosophila/01/movie/Fly_6000_resize.tif'
result_root = '/mnt/nas00/YZ_personal_storage/xxh/proj/proj_dc/exp/nerp_st_3stage/fly'
gen_data_path_all = '/mnt/nas00/YZ_personal_storage/DeepCompress/Database/148_hi_low_noise/Drosophila/01/movie/Fly_rest_resize.tif'
        ...
        for b in [2]:
            for ef in [10]:
                for lr in [2e-4]:
                    ...
                    --patch_x 150 --patch_t 150 --gap_x 75 --gap_t 75 \
