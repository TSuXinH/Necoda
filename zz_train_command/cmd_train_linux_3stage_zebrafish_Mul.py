...
cuda_id = 2
data_path = '/mnt/nas00/YZ_personal_storage/DeepCompress/Database/148_hi_low_noise/Zebrafish/Mul/movie/ZebrafishMul_lowSNR_cropped.tif'
result_root = '/mnt/nas00/YZ_personal_storage/xxh/proj/proj_dc/exp/nerp_st_3stage/zebrafish/Mul'
gen_data_path_all = ''
        ...
        for b in [2]:
            for ef in [10]:
                for lr in [2e-4]:
                    ...
                    --lam_temporal {}  --lam_spatial {} --quant_embed_bit 4 --interp_size_x 10 \
                    --patch_x 200 --patch_t 200 --gap_x 100 --gap_t 100 \
                    --interp_size_t 10 --epoch_stage1 30 --epoch_stage2 50 --remark s1_30_s2_50 \
