...
result_root = '/mnt/nas00/YZ_personal_storage/xxh/proj/proj_dc/exp/nerp_st_huff/ABO/{}'.format(id_abo)
gen_data_path_all = ''
...
for loss in ['L2']:
    for e in [100]:
        for b in [2]:
            for ef in [10]:
                for lr in [2e-4]:
                    os.system("CUDA_VISIBLE_DEVICES={} python train_huff.py --pre_norm min_max --output_path {} --data_path {} \
                    ...
                    --lam_temporal {}  --lam_spatial {} --quant_embed_bit 4 --remark interp8 --interp_size_x 8 --interp_size_t 8 \
                    ".format(a, result_root, data_path, pre_s_rate, pre_t_rate, s_emb_dim, t_emb_dim,
