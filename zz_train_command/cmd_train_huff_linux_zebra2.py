...
dir_list = [item for item in dir_list if '2019' in item]
dir_list = sorted(dir_list)
print(dir_list)
data_path = os.path.join(base_path, dir_list[0])
        ...
        for b in [2]:
            for ef in [10]:
                for lr in [2e-4]:
                    ...
                    --chns_list {} --lam_perceptual {}  --selected_perceptual_layer {} --apply_augmentation \
                    --lam_temporal {}  --lam_spatial {} --quant_embed_bit 4 --interp_size_x 10 --interp_size_t 10 -g {} --remark spine_interp10 \
